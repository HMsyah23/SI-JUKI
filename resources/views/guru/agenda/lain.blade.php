                        ...
                        <div class="col-12">
                          <div class="card-box table-responsive">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <button type="button" class="btn btn-purple btn-rounded w-md waves-effect waves-light mb-3 mr-1" data-toggle="modal" data-target=".bs-example-modal-center" ><i class="mdi mdi-plus"></i> Tambah Agenda</button>      
                            ...
                            <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap">
                              ...
                              <tr>
                                  <td>1</td>
                                  <td>30-06-2021</td>
                                  <td>Uji Coba Aplikasi</td>
                                  <td>
                                    Sambutan
                                  </td>
                                  <td>
                                    Uji Coba Pembuatan Dan Pengisian Soal Di Aplikasi Ujian Online
                                  </td>
                                  <td>
