                                            ...
                                            <td>
                                              <div class="btn-group mb-1">
                                                <button data-toggle="modal" data-target="#edit-{{$item->id_jabatan}}" type="button" class="btn btn-warning waves-effect text-dark"><i class="fas fa-edit"></i></button>
                                                  ...
                                                  <button type="button" data-toggle="modal" data-target="#staticBackdrop-{{$item->id_jabatan}}" class="btn btn-danger waves-effect"><i class="fas fa-trash"></i></button>

                                                  <div class="modal fade" id="staticBackdrop-{{$item->id_jabatan}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger">
                                                            <h5 class="modal-title text-white" id="staticBackdropLabel">Yakin Ingin Menghapus Data Jabatan {{ $item->jabatan }} ?</h5>
