                      ...
                      <div class="row">
                              ...
                              <div class="card-box widget-user">
                                  <div class="media">
                                      <div class="avatar-lg mr-3">
                                          <img src="{{asset('images/users/user-3.jpg')}}" class="img-fluid rounded-circle"
                                              alt="user">
                                      </div>
                          ...
                          <div class="col-xl-3 col-md-6">
                              <div class="card-box widget-user">
                                  <div class="media">
                                      <div class="avatar-lg mr-3">
                                          <img src="{{asset('images/users/user-2.jpg')}}" class="img-fluid rounded-circle"
                                              alt="user">
                                      </div>
                                      <div class="media-body overflow-hidden">
                          ...
                          <div class="col-xl-3 col-md-6">
                              <div class="card-box widget-user">
                                  <div class="media">
                                      <div class="avatar-lg mr-3">
                                          <img src="{{asset('images/users/user-10.jpg')}}" class="img-fluid rounded-circle"
                                              alt="user">
                                      </div>
                                      <div class="media-body overflow-hidden">
                              ...
                              <div class="card-box">
                                  ...
                                  <div class="inbox-widget">
                                      ...
                                      <div class="inbox-item">
                                          <a href="#">
                                              <div class="inbox-item-img"><img src="{{asset('images/users/user-1.jpg')}}"
                                      ...
                                      <div class="inbox-item">
                                          <a href="#">
                                              <div class="inbox-item-img"><img src="{{asset('images/users/user-2.jpg')}}"
                                                      class="rounded-circle" alt=""></div>
                                      ...
                                      <div class="inbox-item">
                                          <a href="#">
                                              <div class="inbox-item-img"><img src="{{asset('images/users/user-3.jpg')}}"
                                                      class="rounded-circle" alt=""></div>
                                      ...
                                      <div class="inbox-item">
                                          <a href="#">
                                              <div class="inbox-item-img"><img src="{{asset('images/users/user-4.jpg')}}"
                                                      class="rounded-circle" alt=""></div>
                                      ...
                                      <div class="inbox-item">
                                          <a href="#">
                                              <div class="inbox-item-img"><img src="{{asset('images/users/user-5.jpg')}}"
                                                      class="rounded-circle" alt=""></div>
