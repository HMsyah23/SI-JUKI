      ...
      <div class="col-12">
        <div class="card-box table-responsive">
          <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('kepsek.laporan.semua',$agendas[0]->guru->id_guru)}}" type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light mb-3"><i class="fas fa-eye"></i> History Semua Kegiatan</a>      
          </div>
          <div class="row">
            <div class="col-lg-4">
              <div class="row">
            ...
            <div class="col-lg-8">
              <div class="d-flex justify-content-between">
                <label for="">Daftar Kegiatan {{$agendas[0]->created_at->isoFormat('dddd, DD/MM/Y')}}</label>
